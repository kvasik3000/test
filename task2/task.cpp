...
int main(int argc, char* argv[]){
    ...
    for (int i = 1; i < tol-1; ++i)
    {
        ...
        matrix[i][tol-1]=matrix[0][tol-1] + (10.0 /(tol-1))*i;
        new_matrix[0][i]=new_matrix[0][0] + (10.0 /(tol-1))*i;
        new_matrix[i][0]=new_matrix[0][0] + (10.0 /(tol-1))*i;
        new_matrix[tol-1][i]=new_matrix[tol-1][0] + (10.0 /(tol-1))*i;
        new_matrix[i][tol-1]=new_matrix[0][tol-1] + (10.0 /(tol-1))*i;
    }
